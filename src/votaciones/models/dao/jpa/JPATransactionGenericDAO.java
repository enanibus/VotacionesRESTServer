...
import votaciones.models.dao.TransactionGenericDAO;
...
public class JPATransactionGenericDAO<T, ID> implements TransactionGenericDAO<T, ID> {
    ...
    public JPATransactionGenericDAO(Class<T> persistentClass) {
        this.persistentClass = persistentClass;
        this.em = ((JPADAOFactory) JPADAOFactory.getFactory()).getEm();
    }
